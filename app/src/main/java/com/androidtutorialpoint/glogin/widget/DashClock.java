...
package com.androidtutorialpoint.glogin.widget;

import android.content.Intent;

import com.androidtutorialpoint.glogin.Pedometer;
import com.androidtutorialpoint.glogin.Database;
import com.androidtutorialpoint.glogin.Fragment_Overview;
import com.androidtutorialpoint.glogin.R;
...
public class DashClock extends DashClockExtension {
    ...
    protected void onUpdateData(int reason) {
        ...
        data.visible(true).status(Fragment_Overview.formatter.format(steps))
                ...
                .clickIntent(new Intent(DashClock.this, Pedometer.class));
        db.close();
        publishUpdate(data);
    }
