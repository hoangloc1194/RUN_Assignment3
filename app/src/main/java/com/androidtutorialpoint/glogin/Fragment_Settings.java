...
import com.androidtutorialpoint.glogin.util.API23Wrapper;
...
public class Fragment_Settings extends PreferenceFragment implements OnPreferenceClickListener {
    ...
    public void onStart() {
        super.onStart();
        Log.i("Setting pedometer", "Now running onStart");
    }

    @Override
    public void onResume() {
        Log.i("Setting pedometer", "Now running onResume");
        super.onResume();
    }

    @Override
    public void onPause() {
        Log.i("Setting pedometer", "Now running onPause");
        super.onPause();
    }

    @Override
    public void onStop() {
        Log.i("Settings pedometer", "Now running onStop");
        super.onStop();
    }
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        Log.i("Settings pedometer", "Now running onCreate");
        ...
        PlaySettingsWrapper
                .setupAccountSetting(account, savedInstanceState, (Pedometer) getActivity());
    ...
    public void onSaveInstanceState(final Bundle outState) {
        ...
        PlaySettingsWrapper.onSavedInstance(outState, (Pedometer) getActivity());
    }
