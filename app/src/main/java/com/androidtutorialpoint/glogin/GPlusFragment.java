...
public class GPlusFragment extends Fragment implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private at.markushi.ui.CircleButton letsgo;
    ...
    public void onResume() {
        Log.i("GplusFragment", "Now running onResume");
        super.onResume();
    }

    @Override
    public void onPause() {
        Log.i("GplusFragment", "Now running onPause");
        super.onPause();
    }

    @Override
    public void onStop() {
        Log.i("GplusFragment", "Now running onStop");
        super.onStop();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("GplusFragment", "Now running onCreate");
...
// options specified by gso.
        mGoogleApiClient = new GoogleApiClient.Builder(getActivity())
                ...
                .build();
        Log.i("GPlusFragment tag","now running onCreate");
    }
...
//        listFeature = (Button) v.findViewById(R.id.list_feature);
//        listFeature.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Intent listFt = new Intent(view.getContext(),Animation.class);
//                startActivity(listFt);
//                getActivity().overridePendingTransition(R.anim.clockwise_in,R.anim.clockwise_out);
//
//            }
//        });
        ...
        letsgo = (at.markushi.ui.CircleButton) v.findViewById(R.id.letsgo);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            final String message = "Welcome " + acct.getDisplayName().toString() + " to RUN! \n Let's get active";
            final Intent intent = new Intent (GPlusFragment.this.getActivity(), Animation.class);
